    ...
    const sampleNotifications: Notification[] = [
      {
        ...
        severity: "critical",
        title: "Israel Travel Restricted",
        message: "Due to ongoing regional tensions, Carta has temporarily restricted non-essential business travel to Israel. Essential travel requires C-suite approval.",
        countryCode: "IL",
        createdAt: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString(),
        expiresAt: null,
        read: false,
        actionUrl: "/advisories",
      },
      {
        id: "notif-2",
        type: "TRAVEL_ADVISORY",
        ...
        expiresAt: null,
        read: false,
        actionUrl: "/assess?destination=GB",
      },
      {
        id: "notif-3",
        type: "TRAVEL_ADVISORY",
        severity: "warning",
        title: "Mexico - Regional Warnings",
        message: "US State Department has issued Level 3 (Reconsider Travel) advisories for several Mexican states due to crime. Check advisories before booking travel.",
        countryCode: "MX",
      ...
      },
      {
        ...
        type: "TRAVEL_ADVISORY",
        severity: "warning",
        title: "China - VP Approval Required",
        message: "All travel to China now requires VP-level approval at least 30 days in advance due to enhanced data security protocols. Contact Security team for briefing.",
        countryCode: "CN",
